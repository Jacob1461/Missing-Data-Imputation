...
sunspots_frame <- data.frame(missing = numeric(), series = numeric())
# sunspots
...
#Sunspots
sunspots.locf.rmse <- sapply(sunspots_locf_list, function(imputed) RMSE(imputed, sunspots))
sunspots.mean.rmse <- sapply(sunspots_mean_list, function(imputed) RMSE(imputed, sunspots))
sunspots.linear.rmse <- sapply(sunspots_linear_list, function(imputed) RMSE(imputed, sunspots))
sunspots.kalman.rmse <- sapply(sunspots_kalman_list, function(imputed) RMSE(imputed, sunspots))

RMSE_sunspots <- cbind(sunspots.locf.rmse, sunspots.mean.rmse,sunspots.linear.rmse, sunspots.kalman.rmse)

#Lake
lake.locf.rmse <- sapply(lake_locf_list, function(imputed) RMSE(imputed, LakeHuron))
lake.mean.rmse <- sapply(lake_mean_list, function(imputed) RMSE(imputed, LakeHuron))
lake.linear.rmse <- sapply(lake_linear_list, function(imputed) RMSE(imputed, LakeHuron))
lake.kalman.rmse <- sapply(lake_kalman_list, function(imputed) RMSE(imputed, LakeHuron))

RMSE_lake <- cbind(lake.locf.rmse, lake.mean.rmse,lake.linear.rmse, lake.kalman.rmse)

#Beer

beer.locf.rmse <- sapply(beer_locf_list, function(imputed) RMSE(imputed, beersales))
beer.mean.rmse <- sapply(beer_mean_list, function(imputed) RMSE(imputed, beersales))
beer.linear.rmse <- sapply(beer_linear_list, function(imputed) RMSE(imputed, beersales))
beer.kalman.rmse <- sapply(beer_kalman_list, function(imputed) RMSE(imputed, beersales))

RMSE_lake <- cbind(beer.locf.rmse, beer.mean.rmse,beer.linear.rmse, beer.kalman.rmse)

lynx.locf.rmse <- sapply(lynx_locf_list, function(imputed) RMSE(imputed, lynx))
lynx.mean.rmse <- sapply(lynx_mean_list, function(imputed) RMSE(imputed, lynx))
lynx.linear.rmse <- sapply(lynx_linear_list, function(imputed) RMSE(imputed, lynx))
lynx.kalman.rmse <- sapply(lynx_kalman_list, function(imputed) RMSE(imputed, lynx))

RMSE_lake <- cbind(lynx.locf.rmse, lynx.mean.rmse,lynx.linear.rmse, lynx.kalman.rmse)
